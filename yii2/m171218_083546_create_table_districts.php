...
/**
 * Class m171218_083546_create_table_districts
 */
class m171218_083546_create_table_districts extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%districts}}', [
            'id' => $this->string(7),
            'regency_id' => $this->string(4),
            'name' => $this->string()->notNull(),
            'PRIMARY KEY(id)',
        ], $tableOptions);

        $this->batchInsert('{{%districts}}',['id', 'regency_id', 'name'], [
